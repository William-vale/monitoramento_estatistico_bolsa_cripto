...
<!-- Olá, preciso de auxilio para a criação de uma aplicação voltada para monitoramente da bolsa de valores, B3 Brasil, e do mercado de CriptoMoedas, usando API's, imagens, sites e etc. 
